...
func test_character_creation():
    ...
    try:
        ...
        record_test_result(test_name, false, "Character creation failed: " + str(e))
...
func test_character_progression():
    ...
    try:
        ...
        record_test_result(test_name, false, "Character progression failed: " + str(e))
...
func test_character_persistence():
    ...
    try:
        ...
        record_test_result(test_name, false, "Character persistence failed: " + str(e))
...
func test_idle_mechanics():
    ...
    try:
        ...
        record_test_result(test_name, false, "Idle mechanics failed: " + str(e))
...
func test_equipment_system():
    ...
    try:
        ...
        record_test_result(test_name, false, "Equipment system failed: " + str(e))
...
func test_faction_system():
    ...
    try:
        ...
        record_test_result(test_name, false, "Faction system failed: " + str(e))
...
func test_quest_system():
    ...
    try:
        ...
        record_test_result(test_name, false, "Quest system failed: " + str(e))
...
func test_data_loading():
    ...
    try:
        ...
        record_test_result(test_name, false, "Data loading failed: " + str(e))
...
func test_data_validation():
    ...
    try:
        ...
        record_test_result(test_name, false, "Data validation failed: " + str(e))
...
func test_full_game_flow():
    ...
    try:
        ...
        record_test_result(test_name, false, "Full game flow failed: " + str(e))
