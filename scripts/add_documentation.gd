...
func _ready():
    ...
    add_documentation_to_file("res://scripts/character.gd")
    add_documentation_to_file("res://scripts/character_manager.gd")
    add_documentation_to_file("res://scripts/dnd_data.gd")
