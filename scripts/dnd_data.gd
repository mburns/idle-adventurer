...
static var classes = {
	...
	"Bard": {
		...
		"skill_choices": 3,
		"skill_options": ["Animal Handling", "Athletics", "Deception", "History", "Insight", "Intimidation", "Investigation", "Medicine", "Nature", "Perception", "Performance", "Persuasion", "Religion", "Sleight of Hand", "Stealth"],
...
# Get class data
static func get_class(class_name: String) -> Dictionary:
