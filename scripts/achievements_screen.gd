...
# Achievements screen for displaying character achievements
...
func clear_achievement_buttons():
    ...
    var container = %AchievementContainer
...
func create_achievement_button(achievement: Achievement) -> Button:
...
func create_achievement_content(achievement: Achievement) -> Control:
...
func style_unlocked_achievement(button: Button, achievement: Achievement):
...
func style_locked_achievement(button: Button, achievement: Achievement):
...
func get_achievement_icon(rarity: AchievementSystem.AchievementRarity) -> Texture2D:
...
func compare_achievements(a: Achievement, b: Achievement) -> bool:
...
func select_achievement(achievement: Achievement):
