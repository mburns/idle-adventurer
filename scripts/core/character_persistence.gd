...
func deserialize_character(character_data: Dictionary) -> Character:
	...
	# Proficiencies
	var skill_profs = character_data.get("skill_proficiencies", [])
	character.set("skill_proficiencies", skill_profs)

	var tool_profs = character_data.get("tool_proficiencies", [])
	character.set("tool_proficiencies", tool_profs)

	var lang_profs = character_data.get("language_proficiencies", [])
	character.set("language_proficiencies", lang_profs)

	var weapon_profs = character_data.get("weapon_proficiencies", [])
	character.set("weapon_proficiencies", weapon_profs)

	var armor_profs = character_data.get("armor_proficiencies", [])
	character.set("armor_proficiencies", armor_profs)
	character.set("saving_throw_proficiencies", character_data.get("saving_throw_proficiencies", []))

	# Traits and abilities
	character.set("racial_traits", character_data.get("racial_traits", []))
	character.set("known_spells", character_data.get("known_spells", []))
	character.set("active_buffs", character_data.get("active_buffs", []))
