...
func _ready():
	...
	if character_manager.has_save_file():
		...
		character_manager.create_default_character()
...
func _on_character_profile_button_pressed():
	get_tree().change_scene_to_file("res://character_profile.tscn")

func _on_equipment_button_pressed():
	get_tree().change_scene_to_file("res://equipment_screen.tscn")

func _on_journal_button_pressed():
	get_tree().change_scene_to_file("res://journal_screen.tscn")
